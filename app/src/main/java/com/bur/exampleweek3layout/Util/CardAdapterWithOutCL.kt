...
class CardAdapterWithOutCL(private val cards: MutableList<CardWithOutCL>) : RecyclerView.Adapter<CardViewHolderWithOutCL>() {
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): CardViewHolderWithOutCL {
        val from = LayoutInflater.from(parent.context)
        val binding = CardCellBinding.inflate(from, parent, false)
        return CardViewHolderWithOutCL(binding)
    }
